...
if (
    ...
    $sql .= "
        AND issued_books.payment_status = ?
    ";
...
if ($download === 'pdf') {
    ...
    */
    ...
    if (
        ...
        header(
            "Location: fine_report.php?error=select_payment_status"
        );
    ...
    */
    ...
    if ($report_type === 'all') {
        ...
        $pdfTitle = "All Fine Report";

        $pdfSubTitle =
            "Complete Library Fine Report";
    }


    /*
    |--------------------------------------------------------------------------
    | SELECTED PAYMENT STATUS PDF
    |--------------------------------------------------------------------------
    */
        ...
        if (!$statusStmt) {
            ...
            die(
                "Payment status PDF query failed: " .
                htmlspecialchars(
                    $conn->error
                )
            );
        ...
        $pdfSubTitle =
            "Selected Payment Status Fine Report";
    }
...
body.library-dark-mode .payment-paid {
...
body.library-dark-mode .payment-unpaid {
        ...
        <main class="report-page">
            ...
            <div class="report-header">
                ...
                <div class="report-title">
                    ...
                    <p>
                        Download all fine records or selected payment status records as PDF.
                    </p>
                ...
                <div class="report-actions">
                    ...
                    <a
                        ...
                        class="
                            ...
                            no-print
                        "
                        title="Download all fine records"
                    >
                    ...
                    <?php if (
                        ...
                        <a
                            ...
                            class="
                                ...
                                no-print
                            "
                            title="Download selected payment status PDF"
                        >
                    ...
                    <?php else: ?>
                        ...
                        <span
                            class="
                                ...
                                no-print
                            "
                            title="Select Paid or Unpaid first"
                        >
